  ...
  return (
    <div className={classNames}>
      ...
      <Dialog
        ...
        setOpen={(open) => setComfortSuitesDialogOpen(open)}
        title="Comfort Suites"
      >
        <h2>Room Options</h2>
        <p>
          <b>King Studio Suites</b> - One king bed and a pull out sleeper sofa,
          mini refrigerator, microwave, and coffee maker.
          <br />
          Arrival on September 25<sup>th</sup>, 2020 and departure on September
          27<sup>th</sup>, 2020
          <br />
        ...
        <p>
          ...
          shuttle to and from Dulles Airport for any guests that may be flying
          in. The shuttle runs from 7 AM - 10 PM daily upon request.
        </p>
        <p>
          <b>Wedding Shuttle</b> - Comfort Suites will also provide one
          complimentary 14 or 12 passenger van to and from Whitehall Estate with
          10 guaranteed rooms.
        </p>
        <p>
          ...
          <b className={styles.rateCode}>L16V68G / COM</b>. Call 703-777-5800 to
          book.
        </p>
        <h2>How to Book</h2>
        <p>
          To book your room, you can call the hotel directly at 703-669-1650 and
          ask for the Salvatore Wedding room block. You can also{" "}
      ...
      <Dialog
        ...
        setOpen={(open) => setMarriottDialogOpen(open)}
        title="Marriott - SpringHill Suites"
      >
        <h2>Check in/out</h2>
        <p>
        ...
        <h2>Room Options</h2>
        <p>
          <b>1 King with trundle bed</b> ($109 per night plus tax) - One king
          bed and a trundle bed, mini refrigerator, microwave, and coffee maker.
        </p>
        <p>
          <b>2 Queens with trundle bed</b> ($129 per night plus tax) - Two queen
          beds and a trundle bed, mini refrigerator, microwave, and coffee
          maker.
        </p>
        <h2>Breakfast</h2>
        ...
        <p>
          SpringHill Suites provides a complimentary shuttle to and from Dulles
          Airport for any guests that may be flying in. Unfortunately, as of
          April 11<sup>th</sup>, 2021, the shuttle is not running due to
          covid-19. We're hopeful that it will be back up and running by August,
          though!
        </p>
        ...
        <h2>How to Book</h2>
        <p>
          To book your room, you can call the hotel directly at +1-703-723-9300
          and ask for the Salvatore-Gallagher Wedding room block. You can also{" "}
          <a
      ...
      <Dialog
        ...
        setOpen={(open) => setHiltonDialogOpen(open)}
      ...
      >
        ...
        <p>
          ...
          table and a 27-inch TV. Refresh in the bathroom which contains a sleek
          marble vanity, a bathtub and a shower with a rounded shower rod for
          added space and comfort.
          <br />
          <br />
          The suite offers a variety of useful amenities, including a microwave,
          a refrigerator, an MP3 alarm clock and a second 27-inch TV in the
          bedroom.
        </p>
        <p>
          <b>2 Queen Beds nonsmoking</b> ($129 per night plus tax) - Separate
          living room, sofa bed, microwave, refrigerator, 2 TVs WiFi.
          <br />
          <br />
          Enjoy a comfortable stay in this two-room suite with two queen beds.
          Relax in the separate living room featuring an armchair, a sofa bed,
          an activity table and a 27-inch TV. As with all of our suites,
          included is a full cooked-to-order breakfast and our Evening
          Reception. This gives you the ability to tailor your own breakfast
          experience, as well as allowing you to easily unwind and relax in the
          evening after a long day of work or fun. Unwind in the bathroom which
          contains a marble vanity and a bathtub and shower with a curved shower
          rod for added space.
          <br />
          <br />
          The suite offers several convenient features, including a microwave, a
          refrigerator, an MP3 alarm clock and a second 27-inch TV in the
          bedroom.
        </p>
        ...
        <p>
          ...
          <br />
          There is also an on-site restaurant where guests can purchase lunch
          and/or dinner.
        </p>
        <h2>Airport Shuttle</h2>
        <p>
          As of April 11<sup>th</sup>, 2021, the complimentary Dulles airport
          shuttle is not running at the moment due to covid-19. It might be
          running again by August, however!
          <br />
          If the airport shuttle is running, guests just need to call the hotel
          when they're ready to be picked up. The hotel will send a shuttle
          over, and it should arrive within about 15 minutes!
        </p>
        <h2>Hotel Amenities</h2>
        <p>
          Free breakfast, non-smoking rooms, free WiFi, complimentary evening
          reception, free parking, on-site restaurant, indoor pool, outdoor
          pool, fitness center, airport shuttle, business center.
        </p>
        <h2>When is the Last Day to Book a Room?</h2>
        <p>
          Rooms in the hotel wedding block can be booked until 24 hours before
          your planned check-in date! So for most guests, that means you can
          wait to reserve a room until August 26<sup>th</sup> at the latest. We
          would recommend booking sooner than 24 hours out just to be safe
          though!
        </p>
        <h2>How to Book</h2>
        <p>
          To book your room, you can call the hotel directly at +1-703-723-5300
          and ask for the Gallagher/Salvatore Wedding room block. You can also{" "}
          <a
