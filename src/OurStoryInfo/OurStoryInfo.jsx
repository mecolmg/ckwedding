  ...
  return (
    <div className={styles.ourStoryInfo}>
      ...
      <p>
        ...
        before Colm{"'"}s birthday, Colm visited Katie at the frozen yogurt shop
        she was working at in high school, enjoyed a frozen yogurt after the
        shop closed, and officially started dating!
      </p>
      <p>
        They had their first date on Colm{"'"}s 17th birthday--no pressure...
        They went to see an R-rated movie to celebrate. Turns out it wasn{"'"}t
        a very popular movie, so they had the ENTIRE THEATER to themselves!
      </p>
      <div className={styles.horizontalImages}>
